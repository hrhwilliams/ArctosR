...
In this example, we query Arctos for all specimens of genus Microtus which were
collected in Mongolia and are currently held in the Museum of Southwestern
Biology's mammal collection. To begin, make sure to load the library:
...
query. Finally, we specify we want to download all records. This is necessary
because Arctos paginates results, returning only 100 at one time. Setting
