...
To use most of ArctosR, you will need to request an API key from Arctos. See
[https://handbook.arctosdb.org/documentation/api.html](https://handbook.arctosdb.org/documentation/api.html).
