...
- Package no longer has a package-level API key. Users will need to
  request their own API key from ‘Arctos’
...
- Add vignette demonstrating using ArctosR for downloading data to show
  the effects of Bergmann’s rule
